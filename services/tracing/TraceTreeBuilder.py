...
class TraceTreeBuilder:
    ...
    def stop_timing(self):
        ...
        self.trace.duration_ns = hr_timestamp_to_nanos(self.trace.end_time) - hr_timestamp_to_nanos(self.trace.start_time)
        self.stopped = True
    ...
    def add_protobuf_error(self, path, error):
        ...
        if isinstance(path, list):
            ...
            if specified_node:
                ...
                print("Could not find node with path " + node_key + "; defaulting to put errors on root node.")
